...
<body>
  ...
  <!-- navigation --> 
        <nav class="navbar navbar-default navbar-fixed-top nav-transparent overlay-nav sticky-nav nav-white nav-border-bottom no-transition" role="navigation">
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-6"><a class="logo-light" href="index.html"><img alt="Veterans Rehab" src="https://s3.amazonaws.com/assets.zipsite.net/images/2013/logo-VeteransRehab-1white.png" class="logo" /></a>
