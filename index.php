...
<style>
    ...
    p.margin-two.text-med.width-90.center-col{
        ...
        <!-- slider section -->
        <section id="slider" class="full-screen no-padding dark-pagination-without-next-prev-arrow onepage-corporate-slider"> 
            <div id="owl-demo" class="owl-carousel owl-theme light-pagination">
                <!-- slider item -->
                <div class="item owl-bg-img" style="background-image:url('http://rdbuploads.s3.amazonaws.com/backgrounds/bg-veteran3.jpg');"><div class="slider-overlay bg-slider"></div>
				...
				<!-- slider item -->
                <div class="item owl-bg-img" style="background-image:url('http://rdbuploads.s3.amazonaws.com/backgrounds/bg-veteran.jpg');"><div class="slider-overlay bg-slider"></div>
                    <div class="container full-screen position-relative">
                        <div class="slider-typography">
                            <div class="slider-text-middle-main">
                                <div class="slider-text-middle">
                ...
                <!-- end slider item -->
			    <!-- slider item -->
                <div class="item owl-bg-img" style="background-image:url('http://rdbuploads.s3.amazonaws.com/backgrounds/bg-veteransrehab5.jpg');"><div class="slider-overlay bg-slider"></div>
                    <div class="container full-screen position-relative">
                        <div class="slider-typography">
                            <div class="slider-text-middle-main">
                                <div class="slider-text-middle">
                                    <h1 class="white-text">support our nations veterans</h1>
                                    <p class="text-large light-gray-text letter-spacing-3 margin-three">Everyday nearly 1000 Soldiers, Sailors and Marines become new Veterans.</p>
                                    <a class="btn-small-white-background btn btn-small no-margin" href="#contact-us">Find out how you can help?</a>
                                </div>
                ...
                <!-- end slider item -->
                <!-- slider item -->
                <div class="item owl-bg-img" style="background-image:url('http://rdbuploads.s3.amazonaws.com/backgrounds/kessler2.jpg');"><div class="slider-overlay bg-slider"></div>
                    <div class="container full-screen position-relative">
                        <div class="slider-typography">
                            <div class="slider-text-middle-main">
                                <div class="slider-text-middle">
                                    <h1 class="white-text">A Unique Veteran Rehab Facility</h1>
                                    <p class="text-large light-gray-text letter-spacing-3 margin-three">Kessler Mansion is future location of Veterans Rehab and one of the most unique private estates in the Midwest.</p>
									<p class="text-large light-gray-text letter-spacing-3 margin-three">16 Veterans and 4 Full-Time support staff on site occupy the 26,000 sq. ft. private estate allowing veterans and growth and wellness professionals plenty of room and opportunity to grow along side the veterans.</p>

                                    <a class="btn-small-white-background btn btn-small no-margin" href="#contact-us">help us make this a reality</a>
                                </div>
                            </div>
                        </div>
                    </div>
