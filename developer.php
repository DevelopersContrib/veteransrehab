...
<title>Developers Veterans Rehab</title>
	<meta name="title" content="Developers Veterans Rehab -<?=$domain?> " />
	<meta name="description" content="Developers Veterans Rehab today and help us create a rehab center fit for our Veterans." />
    </head>
<body>
            ...
            <div class="container">
                <div class="row">
                    <div style="visibility: visible; animation-duration: 300ms; animation-name: fadeInUp;" class="col-md-8 col-sm-12 wow fadeInUp animated" data-wow-duration="300ms">
                        <!-- page title -->
                        <h1 class="black-text">Developers VeteransRehab</h1>
                        <!-- end page title -->
                    </div>
            ...
            <div class="container">
				<div class="row">
                    <div class="col-md-5 col-sm-8 text-center center-col">
                        <p class="title-large text-uppercase letter-spacing-1 black-text font-weight-600">Veterans Rehab Developers</p>
                        <p class="text-large margin-ten">Getting results through personalization and utilization of Technology, Dietary and Education program for todays Veterans. Can you help? Join today and Support a Veteran.</p>
                    </div>
                </div>
                <div class="row">
