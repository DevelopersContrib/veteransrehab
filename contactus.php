...
<title>Contact Veterans Rehab</title>
	<meta name="title" content="Contact Veterans Rehab -<?=$domain?> " />
	<meta name="description" content="Contact Veterans Rehab today and help us create a rehab center fit for our Veterans." />
    </head>
<body>
            ...
            <div class="container">
                <div class="row">
                    <div style="visibility: visible; animation-duration: 300ms; animation-name: fadeInUp;" class="col-md-8 col-sm-12 wow fadeInUp animated" data-wow-duration="300ms">
                        <!-- page title -->
                        <h1 class="black-text">Contact VeteransRehab</h1>
                        <!-- end page title -->
                    </div>
