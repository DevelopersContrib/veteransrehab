...
<title>Fund Veterans Rehab</title>
	<meta name="title" content="Fund Veterans Rehab -<?=$domain?> " />
	<meta name="description" content="Fund Veterans Rehab today and help us create a rehab center fit for our Veterans." />
    </head>
<body>
  ...
  <!-- navigation --> 
        <nav class="navbar navbar-default navbar-fixed-top nav-transparent overlay-nav sticky-nav nav-border-bottom bg-white" role="navigation">
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-6"><a class="logo-light" href="index.html"><img alt="Veterans Rehab" src="http://d2qcctj8epnr7y.cloudfront.net/images/2013/logo-VeteransRehab-1.png" class="logo" /></a>
					<a class="logo-dark" href="#">
					<img alt="Veterans Rehab" src="http://d2qcctj8epnr7y.cloudfront.net/images/2013/logo-VeteransRehab-1.png" class="logo" /></a></div>
            ...
            <div class="container">
                <div class="row">
                    <div style="visibility: visible; animation-duration: 300ms; animation-name: fadeInUp;" class="col-md-8 col-sm-12 wow fadeInUp animated" data-wow-duration="300ms">
                        <!-- page title -->
                        <h1 class="black-text">Fund VeteransRehab</h1>
                        <!-- end page title -->
                    </div>
            ...
            <div class="container">
				<div class="row">
                    <div class="col-md-5 col-sm-8 text-center center-col">
                        <p class="title-large text-uppercase letter-spacing-1 black-text font-weight-600">Veterans Rehab<br> needs $500,000 Capital to run for 1 Year</p>
                        <p class="text-large margin-ten">We need a lot of help but I know you can help in any way you can. Donate as little as $5 and share it with your friends.</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-5 col-sm-8 col-xs-11 center-col xs-no-padding">
					<iframe src="http://ifund.com/campaigns/veterans-rehab/?widget=1" width="99%" height="800px" frameborder="0" scrolling="no" /></iframe>
					</div>
				</div>
			</div>
		</section>		
